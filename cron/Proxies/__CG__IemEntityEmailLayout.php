 ...
 */
class EmailLayout extends \Iem\Entity\EmailLayout implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::getStartTxt();
    }

    public function getEndTxt()
    {
        $this->__load();
        return parent::getEndTxt();
    }

    public function getStartHtml()
    {
        $this->__load();
        return parent::getStartHtml();
    }

    public function getEndHtml()
    {
        $this->__load();
        return parent::getEndHtml();
    }

    public function setStartTxt($startTxt)
    {
        $this->__load();
        return parent::setStartTxt($startTxt);
    }

    public function setEndTxt($endTxt)
    {
        $this->__load();
        return parent::setEndTxt($endTxt);
    }

    public function setStartHtml($startHtml)
    {
        $this->__load();
        return parent::setStartHtml($startHtml);
    }

    public function setEndHtml($endHtml)
    {
        $this->__load();
        return parent::setEndHtml($endHtml);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'startTxt', 'endTxt', 'startHtml', 'endHtml', 'createdAt', 'updatedAt', 'createdBy', 'lastUpdatedBy');
    }
