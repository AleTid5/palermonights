 ...
 */
class Grouping extends \Iem\Entity\Grouping implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'createdAt', 'updatedAt', 'texts', 'subjects', 'createdBy', 'lastUpdatedBy');
    }
