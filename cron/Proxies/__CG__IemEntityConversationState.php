 ...
 */
class ConversationState extends \Iem\Entity\ConversationState implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'description', 'createdAt', 'updatedAt', 'createdBy', 'lastUpdatedBy');
    }
