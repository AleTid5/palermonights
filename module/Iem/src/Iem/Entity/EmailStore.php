 ...
 *
 * @ORM\Entity
 * @ORM\Table(name="email_store")
 *
 * @author Cristian Incarnato
 */

class EmailStore extends \Iem\Entity\ExtendedEntity implements InputFilterAwareInterface {
    ...
    /**
     * 
     * @ORM\ManyToOne(targetEntity="Iem\Entity\EmailConversation")
     * 
     */
