...
$query = $em->createQueryBuilder()
        ...
        ->where("u.smtp = 1")
         ->andWhere("u.email = 'cande.mansilla89@gmail.com'")
        ->setMaxResults(20);
...
if (count($alarmaMails) > 0) {
    ...
    $result = $MailSender->sendMail($mailsBody, "Nuevos mails - " . date("Y-m-d H:i:s"), $emailFrom->getEmail(), $emailFrom->getName(), "charly_ruez@hotmail.com", "Charly");
}
